...
def account_list(search: str, fields: str|list = None, language: str = None, limit: int = None, type_param: str = None) -> AccountListClass|dict[str, AccountListClass]|list[AccountListClass]:
    """
    ...
    request_post = create_url_post("account/list", params)
...
def account_info(account_id: int|list, access_token: str = None, extra: str|list = None, fields: str|list = None, language: str = None) -> AccountInfoClass|dict[str, AccountInfoClass]|list[AccountInfoClass]:
    """
    ...
    request_post = create_url_post("account/info", params)
    if not request_post or not request_post.get("data"):
...
def account_tanks(account_id: int|list, access_token: str = None, fields: str|list = None, language: str = None, tank_id: int|list = None) -> AccountTanksClass|dict[str, AccountTanksClass]|list[AccountTanksClass]:
    """
    ...
    request_post = create_url_post("account/tanks", params)
    if not request_post or not request_post.get("data"):
...
def account_achievements(account_id: int|list, fields: str|list = None, language: str = None) -> AccountAchievementsClass|dict[str, AccountAchievementsClass]|list[AccountAchievementsClass]:
    """
    ...
    request_post = create_url_post("account/achievements", params)
    if not request_post or not request_post.get("data"):
...
def auth_login(display: str = None, expires_at: int = None, nofollow: int = None, redirect_uri: str = None) -> AuthLoginClass|dict[str, AuthLoginClass]|list[AuthLoginClass]:
    """
    ...
    request_post = create_url_post("auth/login", params)
    if not request_post or not request_post.get("data"):
...
def auth_prolongate(access_token: str, expires_at: int = None) -> AuthProlongateClass|dict[str, AuthProlongateClass]|list[AuthProlongateClass]:
    """
    ...
    request_post = create_url_post("auth/prolongate", params)
    if not request_post or not request_post.get("data"):
...
def auth_logout(access_token: str) -> AuthLogoutClass|dict[str, AuthLogoutClass]|list[AuthLogoutClass]:
    """
    ...
    request_post = create_url_post("auth/logout", params)
    if not request_post or not request_post.get("data"):
...
def stronghold_claninfo(clan_id: int|list, fields: str|list = None, language: str = None) -> StrongholdClaninfoClass|dict[str, StrongholdClaninfoClass]|list[StrongholdClaninfoClass]:
    """
    ...
    request_post = create_url_post("stronghold/claninfo", params)
    if not request_post or not request_post.get("data"):
...
def stronghold_clanreserves(access_token: str, fields: str|list = None, language: str = None) -> StrongholdClanreservesClass|dict[str, StrongholdClanreservesClass]|list[StrongholdClanreservesClass]:
    """
    ...
    request_post = create_url_post("stronghold/clanreserves", params)
    if not request_post or not request_post.get("data"):
...
def stronghold_activateclanreserve(access_token: str, reserve_level: int, reserve_type: str, fields: str|list = None, language: str = None) -> StrongholdActivateclanreserveClass|dict[str, StrongholdActivateclanreserveClass]|list[StrongholdActivateclanreserveClass]:
    """
    ...
    request_post = create_url_post("stronghold/activateclanreserve", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_fronts(fields: str|list = None, front_id: str|list = None, language: str = None, limit: int = None, page_no: int = None) -> GlobalmapFrontsClass|dict[str, GlobalmapFrontsClass]|list[GlobalmapFrontsClass]:
    """
    ...
    request_post = create_url_post("globalmap/fronts", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_provinces(front_id: str, arena_id: str = None, daily_revenue_gte: int = None, daily_revenue_lte: int = None, fields: str|list = None, landing_type: str = None, language: str = None, limit: int = None, order_by: str = None, page_no: int = None, prime_hour: int = None, province_id: str|list = None) -> GlobalmapProvincesClass|dict[str, GlobalmapProvincesClass]|list[GlobalmapProvincesClass]:
    ...
    request_post = create_url_post("globalmap/provinces", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_claninfo(clan_id: int|list, access_token: str = None, fields: str|list = None) -> GlobalmapClaninfoClass|dict[str, GlobalmapClaninfoClass]|list[GlobalmapClaninfoClass]:
    """
    ...
    request_post = create_url_post("globalmap/claninfo", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_clanprovinces(clan_id: int|list, access_token: str = None, fields: str|list = None, language: str = None) -> GlobalmapClanprovincesClass|dict[str, GlobalmapClanprovincesClass]|list[GlobalmapClanprovincesClass]:
    """
    ...
    request_post = create_url_post("globalmap/clanprovinces", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_clanbattles(clan_id: int, fields: str|list = None, language: str = None, limit: int = None, page_no: int = None) -> GlobalmapClanbattlesClass|dict[str, GlobalmapClanbattlesClass]|list[GlobalmapClanbattlesClass]:
    """
    ...
    request_post = create_url_post("globalmap/clanbattles", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_seasons(fields: str|list = None, language: str = None, limit: int = None, page_no: int = None, season_id: str = None, status: str = None) -> GlobalmapSeasonsClass|dict[str, GlobalmapSeasonsClass]|list[GlobalmapSeasonsClass]:
    """
    ...
    request_post = create_url_post("globalmap/seasons", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_seasonclaninfo(clan_id: int, season_id: str, vehicle_level: str|list, fields: str|list = None) -> GlobalmapSeasonclaninfoClass|dict[str, GlobalmapSeasonclaninfoClass]|list[GlobalmapSeasonclaninfoClass]:
    """
    ...
    request_post = create_url_post("globalmap/seasonclaninfo", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_seasonaccountinfo(account_id: int, season_id: str, vehicle_level: str|list, fields: str|list = None) -> GlobalmapSeasonaccountinfoClass|dict[str, GlobalmapSeasonaccountinfoClass]|list[GlobalmapSeasonaccountinfoClass]:
    """
    ...
    request_post = create_url_post("globalmap/seasonaccountinfo", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_seasonrating(season_id: str, vehicle_level: str, fields: str|list = None, limit: int = None, page_no: int = None) -> GlobalmapSeasonratingClass|dict[str, GlobalmapSeasonratingClass]|list[GlobalmapSeasonratingClass]:
    """
    ...
    request_post = create_url_post("globalmap/seasonrating", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_seasonratingneighbors(clan_id: int, season_id: str, vehicle_level: str, fields: str|list = None, limit: int = None) -> GlobalmapSeasonratingneighborsClass|dict[str, GlobalmapSeasonratingneighborsClass]|list[GlobalmapSeasonratingneighborsClass]:
    """
    ...
    request_post = create_url_post("globalmap/seasonratingneighbors", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_events(event_id: str = None, fields: str|list = None, language: str = None, limit: int = None, page_no: int = None, status: str = None) -> GlobalmapEventsClass|dict[str, GlobalmapEventsClass]|list[GlobalmapEventsClass]:
    """
    ...
    request_post = create_url_post("globalmap/events", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_eventclaninfo(clan_id: int, event_id: str, front_id: str|list, fields: str|list = None) -> GlobalmapEventclaninfoClass|dict[str, GlobalmapEventclaninfoClass]|list[GlobalmapEventclaninfoClass]:
    """
    ...
    request_post = create_url_post("globalmap/eventclaninfo", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_eventaccountinfo(account_id: int, event_id: str, front_id: str|list, clan_id: int = None, fields: str|list = None) -> GlobalmapEventaccountinfoClass|dict[str, GlobalmapEventaccountinfoClass]|list[GlobalmapEventaccountinfoClass]:
    """
    ...
    request_post = create_url_post("globalmap/eventaccountinfo", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_eventaccountratings(event_id: str, front_id: str, fields: str|list = None, in_rating: int = None, limit: int = None, page_no: int = None) -> GlobalmapEventaccountratingsClass|dict[str, GlobalmapEventaccountratingsClass]|list[GlobalmapEventaccountratingsClass]:
    """
    ...
    request_post = create_url_post("globalmap/eventaccountratings", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_eventaccountratingneighbors(account_id: int, event_id: str, front_id: str, fields: str|list = None, limit: int = None, neighbours_count: int = None, page_no: int = None) -> GlobalmapEventaccountratingneighborsClass|dict[str, GlobalmapEventaccountratingneighborsClass]|list[GlobalmapEventaccountratingneighborsClass]:
    ...
    request_post = create_url_post("globalmap/eventaccountratingneighbors", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_eventrating(event_id: str, front_id: str, fields: str|list = None, limit: int = None, page_no: int = None) -> GlobalmapEventratingClass|dict[str, GlobalmapEventratingClass]|list[GlobalmapEventratingClass]:
    """
    ...
    request_post = create_url_post("globalmap/eventrating", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_eventratingneighbors(clan_id: int, event_id: str, front_id: str, fields: str|list = None, limit: int = None) -> GlobalmapEventratingneighborsClass|dict[str, GlobalmapEventratingneighborsClass]|list[GlobalmapEventratingneighborsClass]:
    """
    ...
    request_post = create_url_post("globalmap/eventratingneighbors", params)
    if not request_post or not request_post.get("data"):
...
def globalmap_info(fields: str|list = None) -> GlobalmapInfoClass|dict[str, GlobalmapInfoClass]|list[GlobalmapInfoClass]:
    """
    ...
    request_post = create_url_post("globalmap/info", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_vehicles(fields: str|list = None, language: str = None, limit: int = None, nation: str|list = None, page_no: int = None, tank_id: int|list = None, tier: int|list = None, type_param: str|list = None) -> EncyclopediaVehiclesClass|dict[str, EncyclopediaVehiclesClass]|list[EncyclopediaVehiclesClass]:
    """
    ...
    request_post = create_url_post("encyclopedia/vehicles", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_vehicleprofile(tank_id: int, engine_id: int = None, fields: str|list = None, gun_id: int = None, language: str = None, profile_id: str = None, radio_id: int = None, suspension_id: int = None, turret_id: int = None) -> EncyclopediaVehicleprofileClass|dict[str, EncyclopediaVehicleprofileClass]|list[EncyclopediaVehicleprofileClass]:
    ...
    request_post = create_url_post("encyclopedia/vehicleprofile", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_achievements(fields: str|list = None, language: str = None) -> EncyclopediaAchievementsClass|dict[str, EncyclopediaAchievementsClass]|list[EncyclopediaAchievementsClass]:
    """
    ...
    request_post = create_url_post("encyclopedia/achievements", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_info(fields: str|list = None, language: str = None) -> EncyclopediaInfoClass|dict[str, EncyclopediaInfoClass]|list[EncyclopediaInfoClass]:
    """
    ...
    """
    params = {'fields': get_str_in_list(fields), 'language': get_str_in_list(language)}
    request_post = create_url_post("encyclopedia/info", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_arenas(fields: str|list = None, language: str = None) -> EncyclopediaArenasClass|dict[str, EncyclopediaArenasClass]|list[EncyclopediaArenasClass]:
    """
    ...
    """
    params = {'fields': get_str_in_list(fields), 'language': get_str_in_list(language)}
    request_post = create_url_post("encyclopedia/arenas", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_provisions(fields: str|list = None, language: str = None, limit: int = None, page_no: int = None, provision_id: int|list = None, type_param: str|list = None) -> EncyclopediaProvisionsClass|dict[str, EncyclopediaProvisionsClass]|list[EncyclopediaProvisionsClass]:
    """
    ...
    request_post = create_url_post("encyclopedia/provisions", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_personalmissions(campaign_id: int|list = None, fields: str|list = None, language: str = None, operation_id: int|list = None, set_id: int|list = None, tag: str|list = None) -> EncyclopediaPersonalmissionsClass|dict[str, EncyclopediaPersonalmissionsClass]|list[EncyclopediaPersonalmissionsClass]:
    """
    ...
    request_post = create_url_post("encyclopedia/personalmissions", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_boosters(fields: str|list = None, language: str = None) -> EncyclopediaBoostersClass|dict[str, EncyclopediaBoostersClass]|list[EncyclopediaBoostersClass]:
    """
    ...
    """
    params = {'fields': get_str_in_list(fields), 'language': get_str_in_list(language)}
    request_post = create_url_post("encyclopedia/boosters", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_vehicleprofiles(tank_id: int, fields: str|list = None, language: str = None, order_by: str = None) -> EncyclopediaVehicleprofilesClass|dict[str, EncyclopediaVehicleprofilesClass]|list[EncyclopediaVehicleprofilesClass]:
    """
    ...
    request_post = create_url_post("encyclopedia/vehicleprofiles", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_modules(extra: str|list = None, fields: str|list = None, language: str = None, limit: int = None, module_id: int|list = None, nation: str|list = None, page_no: int = None, type_param: str|list = None) -> EncyclopediaModulesClass|dict[str, EncyclopediaModulesClass]|list[EncyclopediaModulesClass]:
    """
    ...
    request_post = create_url_post("encyclopedia/modules", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_badges(fields: str|list = None, language: str = None) -> EncyclopediaBadgesClass|dict[str, EncyclopediaBadgesClass]|list[EncyclopediaBadgesClass]:
    """
    ...
    """
    params = {'fields': get_str_in_list(fields), 'language': get_str_in_list(language)}
    request_post = create_url_post("encyclopedia/badges", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_crewroles(fields: str|list = None, language: str = None, role: str|list = None) -> EncyclopediaCrewrolesClass|dict[str, EncyclopediaCrewrolesClass]|list[EncyclopediaCrewrolesClass]:
    """
    ...
    request_post = create_url_post("encyclopedia/crewroles", params)
    if not request_post or not request_post.get("data"):
...
def encyclopedia_crewskills(fields: str|list = None, language: str = None, role: str = None, skill: str|list = None) -> EncyclopediaCrewskillsClass|dict[str, EncyclopediaCrewskillsClass]|list[EncyclopediaCrewskillsClass]:
    """
    ...
    request_post = create_url_post("encyclopedia/crewskills", params)
    if not request_post or not request_post.get("data"):
...
def clanratings_dates(limit: int = None) -> ClanratingsDatesClass|dict[str, ClanratingsDatesClass]|list[ClanratingsDatesClass]:
    """
    ...
    request_post = create_url_post("clanratings/dates", params)
    if not request_post or not request_post.get("data"):
...
def clanratings_clans(clan_id: int|list, date: str = None, fields: str|list = None, language: str = None) -> ClanratingsClansClass|dict[str, ClanratingsClansClass]|list[ClanratingsClansClass]:
    """
    ...
    request_post = create_url_post("clanratings/clans", params)
    if not request_post or not request_post.get("data"):
...
def clanratings_neighbors(clan_id: int, rank_field: str, date: str = None, fields: str|list = None, language: str = None, limit: int = None) -> ClanratingsNeighborsClass|dict[str, ClanratingsNeighborsClass]|list[ClanratingsNeighborsClass]:
    """
    ...
    request_post = create_url_post("clanratings/neighbors", params)
    if not request_post or not request_post.get("data"):
...
def clanratings_top(rank_field: str, date: str = None, fields: str|list = None, language: str = None, limit: int = None, page_no: int = None) -> ClanratingsTopClass|dict[str, ClanratingsTopClass]|list[ClanratingsTopClass]:
    """
    ...
    request_post = create_url_post("clanratings/top", params)
    if not request_post or not request_post.get("data"):
...
def tanks_stats(account_id: int, access_token: str = None, extra: str|list = None, fields: str|list = None, in_garage: str = None, language: str = None, tank_id: int|list = None) -> TanksStatsClass|dict[str, TanksStatsClass]|list[TanksStatsClass]:
    """
    ...
    request_post = create_url_post("tanks/stats", params)
    if not request_post or not request_post.get("data"):
...
def tanks_achievements(account_id: int, access_token: str = None, fields: str|list = None, in_garage: str = None, language: str = None, tank_id: int|list = None) -> TanksAchievementsClass|dict[str, TanksAchievementsClass]|list[TanksAchievementsClass]:
    """
    ...
    request_post = create_url_post("tanks/achievements", params)
    if not request_post or not request_post.get("data"):
...
def tanks_mastery(distribution: str, percentile: int|list, fields: str|list = None, language: str = None, tank_id: int|list = None) -> TanksMasteryClass|dict[str, TanksMasteryClass]|list[TanksMasteryClass]:
    """
    ...
    request_post = create_url_post("tanks/mastery", params)
    if not request_post or not request_post.get("data"):
...
def clans_list(fields: str|list = None, language: str = None, limit: int = None, page_no: int = None, search: str = None) -> ClansListClass|dict[str, ClansListClass]|list[ClansListClass]:
    """
    ...
    request_post = create_url_post("clans/list", params)
    if not request_post or not request_post.get("data"):
...
def clans_info(clan_id: int|list, access_token: str = None, extra: str|list = None, fields: str|list = None, language: str = None, members_key: str = None) -> ClansInfoClass|dict[str, ClansInfoClass]|list[ClansInfoClass]:
    """
    ...
    request_post = create_url_post("clans/info", params)
    if not request_post or not request_post.get("data"):
...
def clans_accountinfo(account_id: int|list, fields: str|list = None, language: str = None) -> ClansAccountinfoClass|dict[str, ClansAccountinfoClass]|list[ClansAccountinfoClass]:
    """
    ...
    """
    params = {'account_id': get_str_in_list(account_id), 'fields': get_str_in_list(fields), 'language': get_str_in_list(language)}
    request_post = create_url_post("clans/accountinfo", params)
    if not request_post or not request_post.get("data"):
...
def clans_glossary(fields: str|list = None, language: str = None) -> ClansGlossaryClass|dict[str, ClansGlossaryClass]|list[ClansGlossaryClass]:
    """
    ...
    """
    params = {'fields': get_str_in_list(fields), 'language': get_str_in_list(language)}
    request_post = create_url_post("clans/glossary", params)
    if not request_post or not request_post.get("data"):
...
def clans_messageboard(access_token: str, fields: str|list = None) -> ClansMessageboardClass|dict[str, ClansMessageboardClass]|list[ClansMessageboardClass]:
    """
    ...
    request_post = create_url_post("clans/messageboard", params)
    if not request_post or not request_post.get("data"):
...
def clans_memberhistory(account_id: int, fields: str|list = None, language: str = None) -> ClansMemberhistoryClass|dict[str, ClansMemberhistoryClass]|list[ClansMemberhistoryClass]:
    """
    ...
    """
    params = {'account_id': get_str_in_list(account_id), 'fields': get_str_in_list(fields), 'language': get_str_in_list(language)}
    request_post = create_url_post("clans/memberhistory", params)
    if not request_post or not request_post.get("data"):
