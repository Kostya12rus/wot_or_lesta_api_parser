...
class ClanratingsTopClass:
    def __init__(self, clanratings_top_data: dict):
        if not clanratings_top_data: clanratings_top_data = {}
        self._clanratings_top: dict = clanratings_top_data
        self.clan_id: int = clanratings_top_data.get('clan_id', 0)
        self.clan_name: str = clanratings_top_data.get('clan_name', '')
        self.clan_tag: str = clanratings_top_data.get('clan_tag', '')
        self.exclude_reasons: dict = clanratings_top_data.get('exclude_reasons', {})

        battles_count_avg_temp: dict = self._clanratings_top.get('battles_count_avg')
        ...
        battles_count_avg_daily_temp: dict = self._clanratings_top.get('battles_count_avg_daily')
        ...
        efficiency_temp: dict = self._clanratings_top.get('efficiency')
        ...
        fb_elo_rating_temp: dict = self._clanratings_top.get('fb_elo_rating')
        ...
        fb_elo_rating_10_temp: dict = self._clanratings_top.get('fb_elo_rating_10')
        ...
        fb_elo_rating_6_temp: dict = self._clanratings_top.get('fb_elo_rating_6')
        ...
        fb_elo_rating_8_temp: dict = self._clanratings_top.get('fb_elo_rating_8')
        ...
        global_rating_avg_temp: dict = self._clanratings_top.get('global_rating_avg')
        ...
        global_rating_weighted_avg_temp: dict = self._clanratings_top.get('global_rating_weighted_avg')
        ...
        gm_elo_rating_temp: dict = self._clanratings_top.get('gm_elo_rating')
        ...
        gm_elo_rating_10_temp: dict = self._clanratings_top.get('gm_elo_rating_10')
        ...
        gm_elo_rating_6_temp: dict = self._clanratings_top.get('gm_elo_rating_6')
        ...
        gm_elo_rating_8_temp: dict = self._clanratings_top.get('gm_elo_rating_8')
        ...
        rating_fort_temp: dict = self._clanratings_top.get('rating_fort')
        ...
        v10l_avg_temp: dict = self._clanratings_top.get('v10l_avg')
        v10l_avg_class = None
        ...
        wins_ratio_avg_temp: dict = self._clanratings_top.get('wins_ratio_avg')
